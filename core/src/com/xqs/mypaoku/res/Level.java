...
public class Level {
    ...
    public static int level01[][]={
            {10,EnemyType.LAJIAO},{20,EnemyType.LUOBO},{30,EnemyType.QIUKUI},{40,EnemyType.YANGCONG},
            {50,EnemyType.QIEZI},{60,EnemyType.LUOBO},{80,EnemyType.CAIHUA},{90,EnemyType.YANGCONG},
            {100,EnemyType.END}
    };

    public static int level02[][]={
            {10,EnemyType.QIUKUI},{20,EnemyType.HUANGGUA},{30,EnemyType.DACONG},{40,EnemyType.LAJIAO},
            {50,EnemyType.END}
    };

    public static int level03[][]={
            {10,EnemyType.YANGCONG},{20,EnemyType.LAJIAO},{30,EnemyType.CAIHUA},{40,EnemyType.LAJIAO},
            {50,EnemyType.END}
    };

    public static int level04[][]={
            {10,EnemyType.YANGCONG},{20,EnemyType.DACONG}, {30,EnemyType.HUANGGUA},{40,EnemyType.MUSHU},
            {50,EnemyType.YUTOU},{60,EnemyType.CAIHUA},{70,EnemyType.DACONG}, {80,EnemyType.HUANGGUA},
            {90,EnemyType.MUSHU},{100,EnemyType.YUTOU},{110,EnemyType.END}
    };
    ...
    public static int levels[][][]={level01,level02,level03,level04,level05,level06,level07,level08,level09};
