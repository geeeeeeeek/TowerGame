...
public class PlayerTwoBullet extends BasePlayerBullet {

    public PlayerTwoBullet(MyPaokuGame game, int clickX, int clickY, float positionX, float positionY, World world) {
        super(game, clickX, clickY, positionX, positionY, world);
    }

    @Override
    public Animation getPlayerFlyAnimation() {
        TextureAtlas.AtlasRegion region = game.getAtlas().findRegion(Res.Atlas.IMAGE_BULLET_PLAYER_TWO_FLY);
