...
public class QiukuiBullet extends BaseBullet {

    public QiukuiBullet(MyPaokuGame game, float positionX, float positionY, World world){
    ...
    public Animation getFlyAnimation() {
        TextureAtlas.AtlasRegion region = game.getAtlas().findRegion(Res.Atlas.IMAGE_BULLET_QIUKUI_FLY);
