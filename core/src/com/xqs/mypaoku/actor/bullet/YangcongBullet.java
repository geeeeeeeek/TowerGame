...
public class YangcongBullet extends BaseBullet {

    public YangcongBullet(MyPaokuGame game, float positionX, float positionY, World world) {
    ...
    public Animation getFlyAnimation() {
        TextureAtlas.AtlasRegion region = game.getAtlas().findRegion(Res.Atlas.IMAGE_BULLET_YANGCONG_FLY);
