...
public class Play extends BaseImageActor{

    public static final String TAG = "Play";
    public static final String PICTURE_BTN_PLAY = "images/btn_play.png";


    private Texture texture;
    private TextureRegion region;

    public Play(MyPaokuGame mainGame) {
        super(mainGame);

        texture = new Texture(Gdx.files.internal(PICTURE_BTN_PLAY));
